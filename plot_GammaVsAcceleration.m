function plot_GammaVsAcceleration(recording,animal,cooling,speeed_threshold)
...
freqlist = [10:1:55]; %10.^(0.4771:0.01:1.1761);
...
subplot(2,3,4)
stairs(freqlist,nanmean(wt_acceleration_cooling),'b'), hold on
stairs(freqlist,nanmean(wt_acceleration_nocooling),'r'), hold on
