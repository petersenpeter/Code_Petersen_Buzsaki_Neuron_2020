function [y1,y2,y3,y4,time1,time2,time3,time4] = plot_ThetaVsSpeed2(session,animal,cooling,interval)
disp('Plotting Theta vs running speed')
bins_speed = [-120:10:120]; % [-40:5:40]; % [5:3:60]
bins_speed_avg = mean([bins_speed(2:end);bins_speed(1:end-1)]);
freqlist = [5:0.1:10]; %10.^(0.4771:0.01:1.1761);
